namespace UrlShortenerModels.Migrations
{
    ...
    using System.Linq;
    using System.Text;
    //public class Configuration : DbMigrationsConfiguration<UrlShortenerModels.DAL.AccountsDbContext>
    //{
    ...
    //    protected override void Seed(UrlShortenerModels.DAL.AccountsDbContext context)
    //    {
    ...
    //            context.Roles.AddOrUpdate(role => role.Name, new IdentityRole[] { new IdentityRole { Name = "Admin" } });

    //            var userToInsert = new ApplicationUser { UserName = adminUserName, Email= adminUserName};
    //            var identityResult = userManager.Create(userToInsert, adminPassword);
